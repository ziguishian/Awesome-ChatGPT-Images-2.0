...
> 收集整理 ChatGPT-Images-2.0 的提示词示例与创意集锦，帮助创作者快速掌握各种风格与生成技巧。  
...
## 透明底图像 PNG
> 生成一张 png 素材图，汉堡爆炸图，纯透明背景

<table>
<tr>
  <td>
    <img width="100%" alt="image" src="https://github.com/user-attachments/assets/a96f1013-6862-4a0b-b24b-29b4f5b9e8e3" />
  </td>
  <td>
    <img width="100%" alt="image" src="https://github.com/user-attachments/assets/8eed2409-c768-420c-a16d-1528bf71734b" />
...
<table>
<tr>
  <td><img width="100%" src="https://github.com/user-attachments/assets/37752df9-8480-4736-8226-87dcea20fec4" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/e9cf2988-3f61-43b3-abcc-35857ccd5c2c" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/25184823-2033-49ff-9e85-9ef6e0b0f5bc" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/05d2c6ea-1071-41a1-af0e-a5f361d586d4" /></td>
</tr>
<tr>
  <td><img width="100%" src="https://github.com/user-attachments/assets/151f21f5-674f-4d0b-a87a-34eb75938d72" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/74d53456-add6-42c4-b369-dbf771706153" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/6a882e40-d66d-4240-afc8-007242d53d88" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/687fa4bb-7f3e-403a-8f1c-562ec8681930" /></td>
</tr>
<tr>
  <td><img width="100%" src="https://github.com/user-attachments/assets/39475af7-91ff-48ac-ace3-46449fe30c0b" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/9265b2f1-ef80-48ad-bf72-03c618815ba9" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/fd442566-6bd7-41d6-8375-5f878a293969" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/0ae0899f-2cc5-472e-8d09-18971114d4d7" /></td>
</tr>
<tr>
  <td><img width="100%" src="https://github.com/user-attachments/assets/7c50a657-4695-4673-b271-4e76cd456ea2" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/18c7a63b-407a-41f2-b138-00869299f139" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/4e21bc01-efec-42c1-8930-41c654de2025" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/84c3470a-8bff-49ee-9951-13b058fe6729" /></td>
</tr>
<tr>
  <td><img width="100%" src="https://github.com/user-attachments/assets/2d73096e-4ea9-4477-998c-71aa61db6512" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/ab55f717-b795-4d68-9d1c-a75cf62f50a7" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/7907d6f5-caa2-46d2-b05c-1874b70d943d" /></td>
  <td><img width="100%" src="https://github.com/user-attachments/assets/bdfb7aa4-7f53-43fe-bce2-98e533a70b5e" /></td>
</tr>
<tr>
  <td><img width="100%" src="https://github.com/user-attachments/assets/b563ad15-5b3e-4d23-91b3-4daa40b616ce" /></td>
    <td><img width="100%" src="https://github.com/user-attachments/assets/1810605c-fb08-43f8-b1c9-c34703ed68d1" /></td>
    <td><img width="100%" src="https://github.com/user-attachments/assets/a3eb2b01-d9ca-4a4b-98c4-ff952d9e9bc6" /></td>
    <td><img width="100%" src="https://github.com/user-attachments/assets/76e6ce04-a4ac-4942-83f8-5924da8ff066" /></td>
...
```text
{
  "type": "social_media_announcement_poster",
  "subject": "AI 产品开放中国市场公告",
  "brand": "Claude / Anthropic",
  "style": "极简科技品牌风格，扁平插画 + 轻3D质感，干净留白，高级设计感",
  "color_palette": {
    "primary": "柔和米白色背景",
    "accent": "橙色（#E87C3A 类似Anthropic品牌色）",
    "secondary": "浅灰色与淡橙渐变"
  },
  "layout": {
    "top_section": "社交媒体帖子界面（类似 Twitter/X UI，包含头像、用户名、认证标、发布时间、互动数据）",
    "bottom_section": "品牌宣传海报卡片，居中展示"
  },
  "poster_content": {
    "headline": "Claude 现在正式向中国用户开放使用",
    "highlight_words": "中国用户（橙色强调）",
    "subtitle": "智能助手，助你高效思考与创作",
    "cta_button": "立即体验 Claude →"
  },
  "visual_elements": [
    "中国地图轮廓（点阵风格，科技感）",
    "上海城市天际线剪影（东方明珠、现代高楼）",
  ...
  "lighting": "柔和均匀光，无强阴影，类似UI设计稿",
  "composition": "中心对齐，信息层级清晰，大面积留白",
  "render_quality": "high resolution, ultra clean UI, modern product design aesthetic",
  "aspect_ratio": "4:5 或 3:4",
  "mood": "正式、科技感、全球化、开放、积极"
}
```  
...
<tr>
    <td>
      <img width="100%" alt="image" src="https://github.com/user-attachments/assets/256297e3-b289-418d-b6dd-dda7591f6791" />
    </td>
</tr>
</table>
...
```text
{
  "type": "modern_high_end_website_landing_page",
  "style": "极简现代，高级科技感，杂志级排版，Apple + Stripe + Notion 风格融合",
  "theme": "AI 产品官网 / 未来工具平台",
  "color_palette": {
    "background": "深色（#0B0B0F）或极浅灰白渐变",
    "primary": "柔和白色文字",
    "accent": "渐变色（蓝紫 / 青绿 / 极光渐变）",
    "secondary": "低饱和灰色，用于辅助信息"
  },
  "layout": {
    "structure": "12-column grid 栅格系统",
    "spacing": "大留白，高呼吸感",
    "alignment": "严格对齐，视觉秩序强",
    "sections": [
      "Hero 首屏（大标题 + 简短描述 + CTA按钮）",
      "产品能力模块（卡片式）",
      "功能展示（左右交错图文）",
      "视觉展示区（mockup / UI截图）",
      "用户价值 / use cases",
  ...
  "hero_section": {
    "headline": "超大号字体（无衬线），简洁有力，2~3行",
    "subheadline": "一句解释产品价值的话，控制在20字以内",
    "cta": "圆角按钮，轻微发光或渐变",
    "background": "微弱渐变光晕 / mesh gradient / 极光流动"
  },
  "ui_elements": [
    "玻璃拟态（glassmorphism）卡片",
    "微阴影（soft shadow）",
    "极细边框（1px translucent border）",
    "圆角（12px ~ 24px）",
    "hover 微交互（scale + opacity）"
  ],
  "typography": {
    "font": "Inter / SF Pro / Helvetica Neue",
    "headline_weight": "600-700",
    "body_weight": "400-500",
    "line_height": "宽松，提高可读性"
  },
  "visual_elements": [
    "抽象科技背景（渐变流体 / 粒子 / 光晕）",
    "产品UI mockup（mac / mobile）",
    "数据可视化元素（极简图表）",
    "AI/未来感图形（网格、连接线、点阵）"
  ],
  "lighting": "柔和环境光 + 局部高光，增强层次",
  "render_style": "超清UI设计稿，dribbble / awwwards 级别",
  "interaction_hint": "微动效设计（scroll reveal / parallax / hover transition）",
  "mood": "冷静、理性、未来感、可信赖、精致",
  "keywords": [
    "minimal",
    "high-end",
    "clean UI",
  ...
  "aspect_ratio": "16:9 或 超长网页截图（9:16）"
}
```  
...
<tr>
    <td>
      <img width="100%" alt="image" src="https://github.com/user-attachments/assets/7c6b806e-6ca8-45d1-b657-7730295fd260" />
    </td>
</tr>
</table>
